...
dirpath <- file.path('method3', 'validation_tables')
...
dat <- l |> 
    ...
    arrange(-meanMCC)
    # drop_na()
write_tsv(x = dat, file = 'method3/validation_tables/merged_data.tsv')
